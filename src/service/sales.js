...
class ServiceSales extends Component{
    render(){
        return(
            <div>
                <NavBar/>
                            ...
                            <div className="row">
                                <div className="col-lg-8 col-12 order-1 order-lg-2">
                                    <div className="service-details">
                                        <ServiceGallery serviceName={'sales'}/>
                                        <div className="content section-space--top--30">
                                            <div className="row">
                                                <div className="col-12">
                                                    <h2>Eszközkereskedelem</h2>
                                                    <p>Társaságunk vezető európai, valamint tengerentúli gyártók világszínvonalú berendezéseinek forgalmazásával, lehetővé teszi a baromfitartók számára a legújabb és következő évtizedekre előremutató műszaki technológia alkalmazását.</p>
